...
describe('ProductListComponent', () => {
    ...
    TestBed.configureTestingModule({
      ...
      imports: [ HttpClientTestingModule, 
        RouterTestingModule.withRoutes([ {
          path: 'products/list/1' , component: ProductDetailsComponent
        }])],
  
      providers:[{ provide: ProductService, useValue: mockProdcutService }],
  ...
  it('should call product list method on initialize of components', () => {
  ...
  it('should call product list method on initialize of components', () => {
   // spyOn(component, 'getAllProducts')
    component.ngOnInit();
    fixture.detectChanges();
    let productsCount = fixture.debugElement.queryAll(By.css('ion-card'));
    expect(productsCount.length).toEqual(20);

  })

  it('should navigate to product details component on click of selected the product', waitForAsync(() => {
    //spyOn(component, 'getAllProducts')
    component.ngOnInit();
    fixture.detectChanges();
    let product = fixture.debugElement.query(By.css('ion-card'));
    expect(product.attributes['ng-reflect-router-link']).toBe('1'); 
  }))

  
  xit('should navigate to product details component on click of selected the product', fakeAsync(() => {
    //spyOn(component, 'getAllProducts')
    component.ngOnInit();
    fixture.detectChanges();
   let product = fixture.debugElement.query(By.css('ion-card'));
